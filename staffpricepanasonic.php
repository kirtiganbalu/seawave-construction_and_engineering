...
<body>
  ...
  <div class="bg">
	...
	<section>
	  <table align="center">
	<tr>
	<th colspan="12" bgcolor="#C0C0C0">AIRCOND (PANASONIC)</th> 
	</tr>
...
$i =0;
$sql="SELECT * FROM pricepanasonic";
...
<td align="center"><?php echo $rows['type_panasonic']; ?></td>
<td align="center"><?php echo $rows['hp_panasonic']; ?></td>
<td align="center"><?php echo $rows['noninverter_panasonic']; ?></td>
<td align="center"><?php echo $rows['inverter_panasonic']; ?></td>
<td align="center"><?php echo $rows['install_panasonic']; ?></td>
<td align="center"><?php echo $rows['normalservice_panasonic']; ?></td>
<td align="center"><?php echo $rows['chemicalservice_panasonic']; ?></td>
<td align="center"><?php echo $rows['hacking_panasonic']; ?></td>
<td align="center"><?php echo $rows['cooper_panasonic']; ?></td>
<td align="center"><a href="deletepricepanasonic.php?hp_panasonic=<?php echo $rows['hp_panasonic'];?>">Delete</a></td>
<td align="center"><a href="staffpricepanasonicupdate.php?hp_panasonic=<?php echo $rows['hp_panasonic'];?>">Update</a></td>
    </tr>
...
$conn->close();?>
	...
	<a href="staffaddnewpanasonic.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
...
include('dbconnect.php');
$i =0;
$sql="SELECT * FROM warrantypanasonic";
...
?>
    <tr class="text">
      <td align="center"><?php echo $i; ?></td>
<td align="center"><?php echo $rows['hp_panasonic']; ?></td>
<td align="center"><?php echo $rows['wages_panasonic']; ?></td>
<td align="center"><?php echo $rows['warranty_panasonic']; ?></td>
<td align="center"><?php echo $rows['markup_panasonic']; ?></td>
<td align="center"><?php echo $rows['total_panasonic']; ?></td>
<td align="center"><a href="deletewarrantypanasonic.php?hp_panasonic=<?php echo $rows['hp_panasonic'];?>">Delete</a></td>
<td align="center"><a href="staffpricepanasonicwarrantyupdate.php?hp_panasonic=<?php echo $rows['hp_panasonic'];?>">Update</a></td>
    </tr>
<?php
}
}
$conn->close();?>
		 ...
		 <br>
	<div  style="text-align:center" >
	<a href="staffwarrantypanasonic.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
