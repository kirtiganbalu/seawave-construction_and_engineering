...
<body>
  ...
  <div class="hero_area">
	...
	<p  style="font-size: 200%" align="center"> <br><br> Staff List !</p>
                ...
                <form style="text-align: center" action="" method="post" > Enter Name <input type="text" name="name_staff">
...
<?php
                ...
                $sql="SELECT * FROM stafflist WHERE name_staff LIKE '%$name_staff%'"; $result = $conn->query($sql);
                }
                else
                {
                // Retrieve data from database
