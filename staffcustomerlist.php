...
<body>
  ...
  <div class="bg">
    ...
    <!-- about section -->
	  <p  style="font-size: 200%" align="center"> <br><br> Customer List !</p>
			</section>
	
            <form style="text-align: center" action="" method="post" > Enter Name <input type="text" name="name_customer">
  ...
  <tr bgcolor="#F98486">
	...
	<?php
                ...
                $target = "email_customer";
                //check either button search is clicked or not
                if (isset($_POST['search']))
                {
                $name_customer = $_POST['name_customer'];
                // Retrieve data from database
                $sql="SELECT * FROM customerlist WHERE name_customer LIKE '%$name_customer%'"; $result = $conn->query($sql);
                }
                else
                {
                // Retrieve data from database
...
<td align="center"><?php echo $rows['name_customer']; ?></td>
<td align="center"><?php echo $rows['email_customer']; ?></td>
<td align="center"><?php echo $rows['password_customer']; ?></td>
<td align="center"><?php echo $rows['phone_customer']; ?></td>
<td align="center"><a href="deletecustomer.php?email_customer=<?php echo $rows['email_customer'];?>">Delete</a></td>
<td align="center"><a href="staffcustomerupdate.php?email_customer=<?php echo $rows['email_customer'];?>">Update</a></td>
    </tr>
...
<div  style="text-align:center" >
	<a href="staffaddcustomer.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
