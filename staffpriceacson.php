...
<body>
  ...
  <div class="bg">
	...
	<section>
	  <table align="center">
	<tr>
	<th colspan="12" bgcolor="#C0C0C0">AIRCOND (ACSON)</th> 
	</tr>
...
<td align="center"><?php echo $rows['type_acson']; ?></td>
<td align="center"><?php echo $rows['hp_acson']; ?></td>
<td align="center"><?php echo $rows['noninverter_acson']; ?></td>
<td align="center"><?php echo $rows['inverter_acson']; ?></td>
<td align="center"><?php echo $rows['install_acson']; ?></td>
<td align="center"><?php echo $rows['normalservice_acson']; ?></td>
<td align="center"><?php echo $rows['chemicalservice_acson']; ?></td>
<td align="center"><?php echo $rows['hacking_acson']; ?></td>
<td align="center"><?php echo $rows['cooper_acson']; ?></td>
<td align="center"><a href="deletepriceacson.php?hp_acson=<?php echo $rows['hp_acson'];?>">Delete</a></td>
<td align="center"><a href="staffpriceacsonupdate.php?hp_acson=<?php echo $rows['hp_acson'];?>">Update</a></td>
    </tr>
...
$conn->close();?>
	...
	<a href="staffaddnewacson.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
...
?>
    <tr class="text">
      <td align="center"><?php echo $i; ?></td>
<td align="center"><?php echo $rows['hp_acson']; ?></td>
<td align="center"><?php echo $rows['wages_acson']; ?></td>
<td align="center"><?php echo $rows['warranty_acson']; ?></td>
<td align="center"><?php echo $rows['markup_acson']; ?></td>
<td align="center"><?php echo $rows['total_acson']; ?></td>
<td align="center"><a href="deletewarrantyacson.php?hp_acson=<?php echo $rows['hp_acson'];?>">Delete</a></td>
<td align="center"><a href="staffpriceacsonwarrantyupdate.php?hp_acson=<?php echo $rows['hp_acson'];?>">Update</a></td>
    </tr>
<?php
}
}
$conn->close();?>
		 ...
		 <br>
	<div  style="text-align:center" >
	<a href="staffwarrantyacson.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
