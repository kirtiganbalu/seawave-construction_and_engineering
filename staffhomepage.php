...
<body>
  ...
  <div class="bg">
	...
	<section>
	  <table align="center">
	<tr>
	<th colspan="12" bgcolor="#C0C0C0">AIRCOND (DAIKIN)</th> 
	</tr>
...
<td align="center"><?php echo $rows['type_daikin']; ?></td>
<td align="center"><?php echo $rows['hp_daikin']; ?></td>
<td align="center"><?php echo $rows['noninverter_daikin']; ?></td>
<td align="center"><?php echo $rows['inverter_daikin']; ?></td>
<td align="center"><?php echo $rows['install_daikin']; ?></td>
<td align="center"><?php echo $rows['normalservice_daikin']; ?></td>
<td align="center"><?php echo $rows['chemicalservice_daikin']; ?></td>
<td align="center"><?php echo $rows['hacking_daikin']; ?></td>
<td align="center"><?php echo $rows['cooper_daikin']; ?></td>
<td align="center"><a href="deletepricedaikin.php?hp_daikin=<?php echo $rows['hp_daikin'];?>">Delete</a></td>
<td align="center"><a href="staffpricedaikinupdate.php?hp_daikin=<?php echo $rows['hp_daikin'];?>">Update</a></td>
    </tr>
...
$conn->close();?>
	...
	<a href="staffaddnewdaikin.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
...
include('dbconnect.php');
$i =0;
$sql="SELECT * FROM warrantydaikin";
...
?>
    <tr class="text">
      <td align="center"><?php echo $i; ?></td>
<td align="center"><?php echo $rows['hp_daikin']; ?></td>
<td align="center"><?php echo $rows['wages_daikin']; ?></td>
<td align="center"><?php echo $rows['warranty_daikin']; ?></td>
<td align="center"><?php echo $rows['markup_daikin']; ?></td>
<td align="center"><?php echo $rows['total_daikin']; ?></td>
<td align="center"><a href="deletewarrantydaikin.php?hp_daikin=<?php echo $rows['hp_daikin'];?>">Delete</a></td>
<td align="center"><a href="staffpricedaikinwarrantyupdate.php?hp_daikin=<?php echo $rows['hp_daikin'];?>">Update</a></td>
    </tr>
...
$conn->close();?>
		 ...
		 <br>
	<div  style="text-align:center" >
	<a href="staffwarrantydaikin.php"><button style="padding: 5px 20px; width: 10%;background-color: none;">Add New</button></a>
</div>
		 <br>
		 <br>
		 </section>
