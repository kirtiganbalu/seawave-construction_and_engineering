      ...
      <div class="container layout_padding2-top">
        <div class="row">
          <div class="col-md-6 mx-auto">
            <form method="post" action="processbooklist.php">
              <div>
			  ...
			  <select name="TypeOfService">
                  <option value="Tos" disabled selected>SERVICES</option>
			   ...
			   <div>
                <input type="text" required="required" name="Request" placeholder="REQUEST">
              </div>
			  <select name="Time">
                  <option value="Time" disabled selected>TIME</option>
                  <option required="required" value="9:00AM">9:00 AM </option>
				  <option required="required" value="10:00AM">10:00 AM </option>
				  <option required="required" value="11:00AM">11:00 AM </option>
                  <option required="required" value="2:00PM">2:00 PM</option>
				  <option required="required" value="3:00PM">3:00 PM</option>
			 ...
			 <div>
  			  ...
  			  <input type="date" required="required" id="calender" name="Calendar">
			  ...
			  <div class="d-flex justify-content-center ">
				<button ><a style="color: white;" href="staffbooklist.php">
                  BACK
                </a></button>
              </div>
            </form>
