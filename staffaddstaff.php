        ...
        <div class="row">
          <div class="col-md-6 mx-auto">
            <form method="post" action="processaddstaff.php">
			  <div>
                <input type="Id" required="required" name="Id" placeholder="ID">
              </div>
              <div>
                <input type="text" required="required" name="Name" placeholder="NAME">
              </div>
				<div>
                <input type="text" required="required" name="Position" placeholder="POSITION">
              </div>
              <div>
              ...
              <div class="d-flex justify-content-center ">
                <button type="submit" name="save" value="submit"onclick="alert('Sucessfully Add Staff Slot')">Send</button>
              </div>
				 <div class="d-flex justify-content-center ">
   				<button ><a style="color: white;" href="staffstafflist.php">
                  BACK
                </a></button>
              </div>
            </form>
