      ...
      <div class="container layout_padding2-top">
        <div class="row">
          <div class="col-md-6 mx-auto">
            <form method="post" action="processaddcustomer.php">
              <div>
              ...
              <div class="d-flex justify-content-center ">
               <button type="submit" name="save" value="submit"onclick="alert('Sucessfully Add Customer Slot')">Send</button>
				 
              </div>
				            <div class="d-flex justify-content-center ">
				<button ><a style="color: white;" href="staffcustomerlist.php">
                  BACK
                </a></button>
